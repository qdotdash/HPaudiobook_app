...
public class Fragment_book2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(new Sp(getActivity()).getbooknumber()==2){
            nloadingtoggle=true;
        }
        view = inflater.inflate(R.layout.slide2,null);
        ...
        fab2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Sp(getContext()).putbooknumber(2);
                nloadingtoggle = true;
                if(new Sp(getActivity()).getbookready(2)){
                ...
                ifloadplayer.putExtra("booktoloadonclick",2);
    ...
    public void ifready(){
        int flag = 0;
        if(new Sp(getActivity()).getbookready(2)){
            fab2.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.play_media));
