...
public class Fragment_book7 extends Fragment {
    View view;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(new Sp(getActivity()).getbooknumber()==7){
            nloadingtoggle=true;
        }
        view = inflater.inflate(R.layout.slide7,null);
        ...
        fab7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Sp(getContext()).putbooknumber(7);
                nloadingtoggle = true;
                if(new Sp(getActivity()).getbookready(7)){
                ...
                ifloadplayer.putExtra("booktoloadonclick",7);
    ...
    public void ifready(){
        int flag = 0;
        if(new Sp(getActivity()).getbookready(7)){
            fab7.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.play_media));
