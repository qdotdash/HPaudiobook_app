...
public class Fragment_book5 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if(new Sp(getActivity()).getbooknumber()==5){
            nloadingtoggle=true;
        }
        view = inflater.inflate(R.layout.slide5,null);
        ...
        fab5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                new Sp(getContext()).putbooknumber(5);
                nloadingtoggle = true;
                if(new Sp(getActivity()).getbookready(5)){
                ...
                ifloadplayer.putExtra("booktoloadonclick",5);
    ...
    public void ifready(){
        int flag = 0;
        if(new Sp(getActivity()).getbookready(5)){
            fab5.setImageDrawable(ContextCompat.getDrawable(getContext(), R.drawable.play_media));
