...
public class Home extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //     LoadHome();
        ...
        try {
            hpmusic.setDataSource("https://firebasestorage.googleapis.com/v0/b/hpaudiobook1-695d3.appspot.com/o/hpmusic.mp3?alt=media&token=a1d6f485-ddae-464f-bce7-47f7ab07aba9");
            hpmusic.prepare();
        } catch (IOException e) {
            e.printStackTrace();
        }
